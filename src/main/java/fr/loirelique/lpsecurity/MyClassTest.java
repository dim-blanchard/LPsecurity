...
public class MyClassTest {
    ...
    public static void main(String args[]) {
        ...
        asciiChiffre.add((int) '0');
        asciiChiffre.add((int) '1');
        asciiChiffre.add((int) '2');
        asciiChiffre.add((int) '3');
        asciiChiffre.add((int) '4');
        asciiChiffre.add((int) '5');
        asciiChiffre.add((int) '6');
        asciiChiffre.add((int) '7');
        asciiChiffre.add((int) '8');
        asciiChiffre.add((int) '9');
        
        for (int i = 0; i < asciiChiffre.size(); i++) {
            
        System.out.println(asciiChiffre.get(i));
